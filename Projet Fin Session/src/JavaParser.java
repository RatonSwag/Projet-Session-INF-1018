 ...
 */
  final public void CompilationUnit() throws ParseException {
    ...
    jj_consume_token(0);
             /*Analyse reference*/ System.out.println(cl.toString());
  }
...
// Handle classes, interfaces, enums, and annotations.
  ...
  if (attribut=true) { getid=true; }
    if (jj_2_15(2)) {
      ReferenceType();
                     if (attribut=true) { cl.augmentReference(); }
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case BOOLEAN:
      case BYTE:
      ...
      case SHORT:
        PrimitiveType();
                     if (attribut=true) {cl.augmentTypesimple(); }
        break;
      default:
        jj_la1[46] = jj_gen;
        jj_consume_token(-1);
  ...
  Token t;
    t = jj_consume_token(IDENTIFIER);
     String a=t.toString();
      if(getid==true) { cl.ajouterClassRef(a); getid=false;}
