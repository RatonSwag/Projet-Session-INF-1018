...
public class ReverseEngineering {
	...
	public void Add(String name) {
		if (CalledParent) {
			...
			// Fais le tour de la liste pour vérifier si la nom est déja dedans
	...
	public void Print() {
		System.out.println("--La classe hérite de: ");
		if (inherited.size() == 0) {
			System.out.println("La classe n'hérite d'aucune classe ou interface");
		}
		for (String s : inherited) {
			System.out.println(s);
		}

		System.out.println("\n--La classe est associée à: ");
		if (associated.size() == 0) {
			System.out.println("La classe n'est associée à aucune autre classe");
		}
		for (String s : associated) {
			System.out.println(s);
		}
